            ...
            <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div class="mt-4 flex gap-2">
                    <a href="{{ route('teacher.courses.show', $course) }}" 
                       class="flex-1 bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-2 rounded text-center text-sm font-medium">
                        View
                    </a>
                    <a href="{{ route('teacher.quizzes.create') }}?course={{ $course->id }}" 
                       class="flex-1 bg-green-50 hover:bg-green-100 text-green-700 px-3 py-2 rounded text-center text-sm font-medium">
                        Add Quiz
                    </a>
                </div>
            </div>
